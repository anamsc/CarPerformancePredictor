...
Linear Regression: Simple and interpretable, it attempts to model the relationship between mpg and the features using a linear function.
Random Forest: A robust ensemble learning method that uses multiple decision trees to improve prediction accuracy.
Model Evaluation
...
Run the notebook to preprocess the data and train the models.
Future Work
